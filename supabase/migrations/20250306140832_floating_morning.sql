/*
  ...
  1. Initial Data
    ...
    - Bot trading activity with proper user reference
    - Initial sustainability projects
    - Impact metrics for projects

  2. Changes
    - Create bot user first
    - Reference bot user ID in trades
    - Maintain data integrity with proper foreign keys
*/

-- Create bot user first
INSERT INTO auth.users (id, email)
VALUES ('00000000-0000-0000-0000-000000000001', 'trading-bot@system.local')
ON CONFLICT (id) DO NOTHING;

-- Insert into public.users table
INSERT INTO public.users (id, email, name)
VALUES ('00000000-0000-0000-0000-000000000001', 'trading-bot@system.local', 'Trading Bot')
ON CONFLICT (id) DO NOTHING;
